...
class CtrlcombustibleDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'ctrlcombustibles.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Ctrlcombustible $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Ctrlcombustible $model)
    {
        return $model->newQuery()->with(['vehiculo', 'combustible']);
    }
...
//                    ['extend' => 'reload', 'className' => 'btn btn-default btn-sm no-corner',],
    ...
    {
        return 'ctrlcombustibles_datatable_' . time();
    }
}
