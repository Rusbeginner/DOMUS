...
class CtrlicenciaoperativaDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'ctrlicenciaoperativas.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Ctrlicenciaoperativa $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(Ctrlicenciaoperativa $model)
    {
...
//                    ['extend' => 'reload', 'className' => 'btn btn-default btn-sm no-corner',],
    ...
    {
        return 'ctrlicenciaoperativas_datatable_' . time();
    }
}
