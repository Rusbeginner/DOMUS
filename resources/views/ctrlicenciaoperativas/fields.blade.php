...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('fechaemision', $ctrlicenciaoperativa->fechaemision ?? null, ['class' => 'form-control','id'=>'fechaemision']) !!}
...
<div class="form-group col-sm-6">
    ...
    {!! Form::date('fechavenc', $ctrlicenciaoperativa->fechavenc ?? null, ['class' => 'form-control','id'=>'fechavenc']) !!}
